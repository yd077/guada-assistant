      ...
      <main className="mx-auto flex max-w-md flex-col px-6 py-32">
        <Reveal>
          ...
          <button
            ...
            disabled={loading}
            className="mt-6 inline-flex w-full items-center justify-center gap-3 rounded-xl border border-input bg-background px-6 py-3 text-sm font-medium hover:bg-muted disabled:opacity-60"
          >
            <svg className="h-4 w-4" viewBox="0 0 48 48" aria-hidden="true">
              ...
              <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4.1 5.6l6.2 5.2C41.6 35 44 30 44 24c0-1.2-.1-2.3-.4-3.5z"/>
            </svg>
